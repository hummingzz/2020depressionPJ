...
df_Y = pd.DataFrame(load_iris.target, columns=['label'])
...
def Adaptive_LASSO(X_train, y_train, max_iterations=1000, lasso_iterations=10, alpha=0.1, tol=0.001, max_error_up=5,
    ...
    print('=============================================================================')
    print("Adaptive LASSO picked " + str(sum(coef != 0)) + " variables and eliminated the other " + str(
    ...
    plt.savefig('/home/pehuang/zhaozhang/beijing/visualization/lassofigure/iteration_coef.png')
    ...
    plt.savefig('/home/pehuang/zhaozhang/beijing/visualization/lassofigure/top10_coef.png')
